...
@Date:              2023 02 01
@Title:             density_equilibration_metric_bridges.py
...
This is specifically for the use on Bridges2 by PSC.
All the appropriate gmx modules are updated for the supercomputer. The path for the code git repository is also accurate
for Bridges.
...
for time in time_array:
    ...
    convert_xvg = f"python3 /jet/home/dora1300/code/code/Utils/xvg2csv.py -f ./temp_dens/frame{TIME}.xvg -o ./temp_dens/frame{TIME}.csv"
