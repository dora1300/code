...
20220525 - this script is a TEST SCRIPT for me to test the effect of using traj.image_molecules on the trajectory
"""
...
image_traj = traj.image_molecules()
...
aligned = md.Trajectory.superpose(image_traj, ref)
