...
20220310 - fixed a typo in the file name for the KDE contours plot. It WAS "...countours.png" and has been fixed to
"contours.png".
"""
import math as m
import numpy as np
...
if args.plot:
    ...
    plt.savefig(f"{sim_code}_KDEcontours.png", dpi=600)
