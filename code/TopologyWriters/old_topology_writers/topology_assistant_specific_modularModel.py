"""
@Title:             topology_assistant_specific_modularModel.py
@Name:              Mando A Ramirez
@Date:              2022 10 28

@Description:       This script is an extension of "topology_assistant_specific.py" to handle the modular oligomer
