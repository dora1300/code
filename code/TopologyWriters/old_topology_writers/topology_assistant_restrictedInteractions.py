"""
@Title:             topology_assistant_restrictedInteractions.py
...
[ exclusions ]
; This coil interacts through a **RESTRICTED INTERACTION SCHEME**
; this model achieves restricted interactions through using
