"""
@Title:             topology_assistant_partialInteractions.py
...
2022 06 17 - updating the name to reflect the types of INTERACTIONS included between coils, instead of emphasizing
...
[ exclusions ]
; Exclusions only permit inter-model coil interactions
; Exclude ALL A-A interactions in an entire model
; therefore no coil can interact within the same model.
"""
    A_BEADS.sort()
