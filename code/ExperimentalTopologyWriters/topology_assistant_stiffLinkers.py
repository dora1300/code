...
parser.add_argument("-damp", help="The damp parameter to adjust the strength of the linkers."
                    " (Optional) If you don't provide, the automatic value is 0.01", type=float)
