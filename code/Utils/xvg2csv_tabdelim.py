...
parser = argparse.ArgumentParser(description="Converts your .xvg files into .csv files! This is for the weird"
                                 " case of the .xvg file that is tab delimited. It happens sometimes.")
